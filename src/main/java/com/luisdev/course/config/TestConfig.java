...
import com.luisdev.course.entities.*;
import com.luisdev.course.entities.enums.OrderStatus;
import com.luisdev.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Product p1 = new Product(null, "Blue Lock", "lorem ipsum dolor sit amet, consectetur.", 90.5, "");
        ...
        User u1 = new User(null, "Luis Fabiano", "luis@gmail.com", "988888888", "123456");
        User u2 = new User(null, "Rogers Garcia", "rogers@gmail.com", "977777777", "123456");
        ...
        Payment pay1 = new Payment(null, o1, Instant.parse("2026-06-20T21:53:07Z"));
        o1.setPayment(pay1);
